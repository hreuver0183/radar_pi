...
//HAVE_CONTROL(CT_ANTENNA_HEIGHT, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 50, CTD_STEP_1, CTD_NUMERIC) //not known for RME120
...
HAVE_CONTROL(CT_FTC, CTD_AUTO_NO, CTD_DEF_OFF, CTD_MIN_ZERO, 500, CTD_STEP_10, CTD_NUMERIC)
...
HAVE_CONTROL(CT_FT, CTD_AUTO_YES, CTD_DEF_ZERO, CTD_MIN_ZERO, 255, CTD_STEP_1, CTD_NUMERIC)
HAVE_CONTROL(CT_CT, CTD_AUTO_YES, CTD_DEF_ZERO, CTD_MIN_ZERO, 255, CTD_STEP_1, CTD_NUMERIC)
HAVE_CONTROL(CT_STC_CURVE, CTD_AUTO_YES, CTD_DEF_ZERO, CTD_MIN_ZERO, 10, CTD_STEP_1, OFF_ON_NAMES)
HAVE_CONTROL(CT_DISPLAY_TIMING, CTD_AUTO_YES, CTD_DEF_ZERO, CTD_MIN_ZERO, 255, CTD_STEP_1, CTD_NUMERIC)  // display timing
