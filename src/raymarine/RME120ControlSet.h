...
HAVE_CONTROL(CT_TUNE_FINE, CTD_AUTO_YES, CTD_DEF_ZERO, CTD_MIN_ZERO, 255, CTD_STEP_1, CTD_NUMERIC)
HAVE_CONTROL(CT_TUNE_COARSE, CTD_AUTO_YES, CTD_DEF_ZERO, CTD_MIN_ZERO, 255, CTD_STEP_1, CTD_NUMERIC)
